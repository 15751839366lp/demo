...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="${ctp}/teacher/selectCourse" role="form" method="post" id="addForm">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <c:if test="${teaNo!=null}">
                        <input type="text" class="form-control" id="teaNo" readonly="readonly" name="teaNo" style="width: 300px;"  value="${teaNo}">
                    </c:if>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" id="selectNum"  name="selectNum" style="width: 300px;">
                </div>
            </div>
            <div class="form-group">

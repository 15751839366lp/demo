        ...
        <table class="table table-hover  table-bordered table-striped" style="margin-bottom: 0px;">
            ...
            <tr>
                <td style="margin: 0;border: 0;text-align: center" colspan="6">
                    <a href="${ctp}/student/courseList?id=${user.id}">首页</a>
                    <a class="prePage" href="${ctp}/student/courseList?page=${map.courseList.prePage}&id=${user.id}">上一页</a>
                    ${map.courseList.pageNum}
                    <a class="nextPage" href="${ctp}/student/courseList?page=${map.courseList.nextPage}&id=${user.id}">下一页</a>
                    <a href="${ctp}/student/courseList?page=${map.courseList.pages}&id=${user.id}">末页</a>
                </td>
            </tr>
        </table>
        <script>

...
public class MyApriori {
    ...
    private static double MIN_SUPPROT = 0.05;//最小支持度百分比
    ...
    /*public static void main(String args[]){
        ...
        *//*System.out.println("请输入最小支持度（如0.05）和最小置信度（如0.6）");
        ...
        record = getRecord("D:\\Test\\course\\courses\\src\\main\\java\\com\\system\\component\\data.txt");
        //控制台输出记录
        System.out.println("读取数据集record成功===================================");
        ShowData(record);


        List<Integer> apriori =  Apriori();//调用Apriori算法获得频繁项集
    ...
    public static List<Integer> Apriori(List<List<String>> record)           /**实现apriori算法**/
    {
        //************获取候选1项集**************
        ...
        List<List<String>> FrequentItemset = getSupprotedItemset(CandidateItemset,record);
        ...
        while(endTag!=true){
            ...
            List<List<String>> nextFrequentItemset = getSupprotedItemset(nextCandidateItemset,record);
            ...
            if(endTag == true){
                System.out.println("\n\n\nApriori算法--->最大频繁集==================================");
                ShowData(FrequentItemset);
                for(String s : FrequentItemset.get(0)){
     ...
     * 由k项候选集剪枝得到k项频繁集
     */
    private static List<List<String>> getSupprotedItemset(List<List<String>> CandidateItemset,List<List<String>> record) { //对所有的商品进行支持度计数
        ...
        for (int i = 0; i < CandidateItemset.size(); i++){
            ...
            int count = countFrequent1(CandidateItemset.get(i),record);//统计记录数
     ...
     */
    private static int countFrequent1(List<String> list,List<List<String>> record) {//遍历所有数据集record，对单个候选集进行支持度计数
    ...
    //获得一项候选集
    private static List<List<String>> findFirstCandidate(List<List<String>> record) {
        // TODO Auto-generated method stub

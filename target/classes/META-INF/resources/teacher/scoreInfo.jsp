...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" id="editForm" method="post" action="${ctp}/teacher/score">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" id="stuName" name="stuName" style="width: 300px;"
                           value="${score.stu.userName }" readonly="readonly">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">课程名称：</label>
                <div class="col-md-10">
                    <input type="text" class="form-control" id="courseName" name="courseName" style="width: 300px;"
                           value="${score.course.courseName }" readonly="readonly">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">学分：</label>
                <div class="col-md-10">
                    <input type="text" class="form-control" id="credit" name="credit" style="width: 300px;"
                           value="${score.course.credit }" readonly="readonly">
                </div>
            </div>
            <div class="form-group">
